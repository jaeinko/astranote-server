...
{
  "headline": "(20자 이내) 이 관계를 한 문장으로 정의. 캡처해서 공유하고 싶을 만큼 강렬하게. 예: '서로를 편하게 만드는 대신, 설렘을 잃는 사이'",
  "keyword_1": "(6자 이내 관계 키워드)",
  ...
  "card5_conflict": "(500자 이상) 반복되는 갈등 패턴. 마찰각을 근거로 '이 커플이 싸우는 방식'을 대사가 들릴 만큼 구체적으로 그려라. 특히 위험한 지점 한 가지는 <span style='color:#ff3b30;font-weight:900;'>빨간 글씨</span>로 분명히 경고하라.",
  ...
  "card10_teaser": "(3문장) 각자의 개인 차트를 더 깊이 본다면 무엇을 알 수 있는지 궁금증을 남기는 문장. 강매 톤 금지."
}`;
}
