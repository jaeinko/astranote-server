...
const handler = async (req, res) => {
  ...
  try {
    ...
    [글 쓰는 방식 - 꼭 지켜]
    1. 어려운 전문용어를 나열하지 마. 7하우스만 근거로 쓰되, 설명은 쉽고 따뜻한 일상 언어로 풀어라. "당신은~", "당신의 배우자는~" 처럼 눈앞에서 말을 거는 어조로 써라.
    2. 뭉뚱그리지 마. "좋은 사람일 수 있어요" (X) → "당신의 배우자는 말수가 적지만 한번 뱉은 약속은 반드시 지키는 사람입니다" (O) 처럼 딱 집어서 단정해라.
    3. 배우자의 특성은 최대한 구체적으로: 성격, 말투, 분위기, 외모 인상, 직업 느낌, 돈 씀씀이, 만났을 때의 첫 느낌까지.
    4. 만나는 시기는 반드시 구체적인 "연도와 월(예: 2027년 봄, 3월~5월)"로 못 박아라. 절대 생략 금지.
    5. 강조할 문장은 <b> 태그로. 마크다운(*) 금지.
    6. card2부터 card7까지 항목당 최소 500자 이상.
    ...
    [출력 JSON 형식]
    {
      ...
      "card2_analysis": "(최소 500자) 당신은 어떤 사람인지. 당신의 성향과 연애에서 반복돼온 패턴을 따뜻하지만 정확하게 짚어라. 당신에게 직접 말 거는 어조로.",
      "card3_appearance": "(최소 500자) 배우자의 외모. 7하우스를 근거로, 첫인상/눈빛/체형/분위기/스타일을 사진 보듯 생생하게. 곰돌이상, 여우상 같은 비유도 좋다.",
      "card4_career": "(최소 500자) 배우자의 직업과 성격. 어떤 일을 하는 사람인지, 어떤 성격인지, 돈은 어떻게 쓰는지, 당신을 어떻게 대할지를 구체적으로.",
      "card5_timing": "(최소 600자) [필수] 두 사람이 만나는 시기를 반드시 구체적인 연도와 월(예: 2027년 3월~5월)로 못 박아라. 어떻게 만나는지(소개/우연/이미 아는 사이 등)와 만나는 순간의 상황도 실감나게 그려라. 시기 생략 절대 금지.",
      "card6_chemistry": "(최소 400자) 두 사람이 만났을 때의 케미. 어떤 점이 잘 맞고, 어떻게 서로에게 끌리는지를 <b>강조</b> 섞어 감동적으로.",
