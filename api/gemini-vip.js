...
나쁜 예(절대 금지): "긍정적으로 생각하세요", "좋은 일이 있을 겁니다" 같은 하나마나한 덕담 / "~일 수 있습니다" 발뺌 화법 / "가여운", "안타까운" 같은 연민 / 강점을 뭉뚱그리는 것.
...
[출력 JSON 형식]
{
  "vip_card1": "(최소 1600자, 소제목 3개로 나눠서) [CHAPTER 01. 내 삶을 갉아먹는 무의식의 방해 공작] 🚨 냉정한 진단이되, 마지막엔 반드시 강점으로 뒤집어라. 다음 흐름으로 길고 깊게 써라. <b>【타고난 것】</b> 먼저 달·토성·12하우스 등 이 사람의 특이 배치를 차트 근거로 밝히고, 그것이 준 '아무나 못 가진 능력'을 먼저 인정하라 (예: 감정을 깊이 읽는 힘). <b>【무의식의 그림자】</b> 그 능력의 이면에 자리잡은 무의식적 불안·결핍의 정체를 콕 집어라 — 잘 살고 싶은 마음과 반대로 자꾸 스스로를 망치는 선택으로 몰아온 패턴을. 감정을 정확히 읽어 마음을 열되('당신은 늘 혼자 삼켜왔습니다') 불쌍하게 만들지 마라. <b>【반복된 장면】</b> 그 패턴이 관계·일·돈에서 실제로 어떻게 반복됐는지 구체적 장면으로 보여줘라. <b>【뿌리와 열쇠】</b> 이 패턴이 어디서 시작됐는지(4하우스=가정·부모, 12하우스=숨은 상처) 뿌리를 추적하고, 그것이 결함이 아니라 '너무 일찍 유능해진 대가'였음을, 그리고 그 힘이 앞으로 어떻게 무기가 되는지 방향을 제시하라. 마지막엔 <blockquote> 태그로 가슴을 관통하되 힘을 주는 한 문장을 남겨라 (예: '당신은 강한 게 아니라 유능한 사람입니다'). 연민('가여운', '안타까운') 절대 금지.",
