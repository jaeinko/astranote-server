...
[출력 JSON 형식]
{
  "vip_card1": "(최소 1000자 이상) [CHAPTER 01: 무의식의 상처와 깊은 위로] 고객이 남몰래 겪어온 외로움과 투쟁을 깊이 공감하고 위로해라. 그 후 차트를 근거로 대인관계/연애에서 반복되었던 '진짜 결핍'의 원인을 부드럽지만 예리하게 분석하라. 마지막엔 <blockquote>태그를 사용해 가슴을 울리는 묵직한 명언을 넣어라.",
  
  "vip_card2": "(최소 1000자 이상) [CHAPTER 02: 상처를 부(富)로 바꾸는 연금술] 고객이 단점이라 여겼던 기질(예민함 등)이 실제로는 돈과 성공을 끌어당기는 위대한 재능임을 찬사하라. 고객 차트에 맞는 구체적인 직업/비즈니스 방향성과 부의 스케일을 <b>태그로 강조하며 상세히 제시하라.",
  
  "vip_card3": "(최소 1000자 이상) [CHAPTER 03: 성장을 위한 골든 타이밍과 행동 지침] 진짜 행복해지고 부자가 되기 위해 당장 끊어내야 할 악연(레드플래그)을 <span style='color:#ff3b30;font-weight:900;'>빨간색 글씨</span>로 강하게 조언하라. 운이 폭발적으로 상승하는 연/월을 명시하고, 스스로를 굳게 믿으라는 열정적인 축복으로 마무리하라."
}
    `;
